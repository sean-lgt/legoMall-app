 ...
 * @Description: 
 * @Author: lgt
 * @Date: 2021-06-06 11:35:55
 * @LastEditTime: 2021-07-24 12:24:05
 * @LastEditors: xxx
-->
<template>
    <div class="create-order">
        <s-header :name="'生成订单'"
                  @callback="deleteLocal"></s-header>
        ...
        <div class="pay-wrap">
            ...
            <van-button @click="handleCreateOrder"
                        class="pay-btn"
                        color="#1baeae"
                        type="primary"
        ...
        <van-popup closeable
            ...
            <div :style="{ width: '90%', margin: '0 auto', padding: '50px 0' }">
                ...
                <van-button color="#4fc08d"
                            block
                            @click="handlePayOrder(2)">微信支付</van-button>
            </div>
        </van-popup>
    </div>
</template>
